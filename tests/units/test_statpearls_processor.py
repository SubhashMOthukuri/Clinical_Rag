...
Covers StatPearlsProcessor public and private methods:
- _clean_text
- _extract_title
- _extract_sections
- _extract_article
...
Chunking logic (chunk_text, assign_ids, chunk_article) is tested separately
in tests/units/test_chunker.py.
"""
...
ChunkConfig = _mod.ChunkConfig  # re-exported via src.chunking import in processor module
